...
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test1',1234,'관리자','윤주현','1996-03-25','010-4413-5698','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test2',1235,'관리자','허수빈','2001-01-05','010-3217-5620','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test3',1236,'관리자','최예슬','2000-09-24','010-3160-9231','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test4',1237,'관리자','김우중','2000-02-16','010-9874-2338','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test5',1238,'관리자','최예슬','2000-09-24','010-3160-9231','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test6',1239,'관리자','김우중','2000-02-16','010-9874-2338','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test7',1241,'관리자','최예슬','2000-09-24','010-3160-9231','false', 100000);
INSERT INTO User(id, password, type, name, birthDay, phoneNumber, blackList, point) VALUES('test8',1240,'관리자','김우중','2000-02-16','010-9874-2338','false', 100000);
